    ...
    <GeSection background="white" className="pt-24 pb-16 sm:pt-28 sm:pb-20">
      <div className="grid gap-12 lg:grid-cols-[0.45fr_0.55fr] lg:items-start">
        <motion.div className="flex flex-col items-center text-center lg:items-start lg:text-left" {...fadeUp}>
          <p className="font-ge text-[0.96rem] font-bold uppercase tracking-[0.16em] text-ge-orange sm:text-[1rem]">
            {factsCopy.eyebrow}
          </p>
          <h2 className="mt-4 font-ge text-[2.3rem] font-extrabold uppercase leading-[1.06] tracking-[0.015em] text-gs-green sm:text-[2.9rem]">
            {factsCopy.title}
          </h2>
          <div className="mt-8">
            <IrishOwnedSeal
      ...
      <div className="mt-16 flex flex-col items-center gap-6 border-t border-ge-gray100 pt-14 text-center">
        <h3 className="font-ge text-[1.95rem] font-bold uppercase tracking-[0.03em] text-gs-green sm:text-[2.15rem]">
          {factsCopy.ctaTitle}
        </h3>
