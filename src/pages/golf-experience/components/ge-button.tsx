...
const baseClasses =
  'inline-flex items-center justify-center gap-2 rounded-[var(--gsi-button-radius)] px-[var(--gsi-button-padding-x)] py-[var(--gsi-button-padding-y)] font-ge font-bold uppercase tracking-[0.14em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gs-electric focus-visible:ring-offset-2'
