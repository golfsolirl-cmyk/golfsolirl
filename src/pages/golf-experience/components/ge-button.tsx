...
const sizes: Record<Size, string> = {
  sm: 'min-h-[44px] text-base sm:text-[0.85rem]',
  md: 'min-h-[48px] text-base sm:text-[0.9rem]',
  lg: 'min-h-[56px] text-lg sm:text-[1rem]'
}
...
const baseClasses =
  'inline-flex items-center justify-center gap-2 rounded-[var(--theme-button-radius)] px-[var(--theme-button-padding-x)] py-[var(--theme-button-padding-y)] font-ge font-bold uppercase tracking-[0.14em] transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gs-electric focus-visible:ring-offset-2'
