...
export const BRAND_MARKETING_HERO_COMPOSITE_REFERENCE_SRC =
  '/images/afeeead4-ada3-4630-9fa1-56c95b438e98.webp'
...
export const BRAND_MARKETING_HERO_DESKTOP = {
  webp: '/images/fpf-bcadd429-0f8b-4b75-afdd-f521413396c5.webp'
} as const
...
export const BRAND_MARKETING_HERO_MOBILE = {
  webp: '/images/fpf-cover-ba19c50a-8f84-4a1c-89ce-60aa6278573f-mobile.webp'
} as const

/** Legacy alias (still imported by some pages). Points at the desktop banner above. */
export const BRAND_MARKETING_HERO_COMPOSITE_SRC = BRAND_MARKETING_HERO_DESKTOP.webp
...
export const BRAND_MARKETING_SCENIC_HERO_SPLIT_SRC = '/images/hero-image-p.webp'
 ...
 */
export const BRAND_MARKETING_RASTER_HERO_SRC = '/images/himage.webp'
...
export const BRAND_MARKETING_RASTER_HERO_REFERENCE_SRC = '/images/hero-malaga-transfer-reference.webp'
...
export const BRAND_CLIENT_PORTAL_HERO_ILLUSTRATION_SRC = '/images/client-portal-hero-illustration.webp'
