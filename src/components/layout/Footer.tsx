...
export function Footer() {
  return (
    <footer className="bg-[#123811] text-white py-20 md:py-24" role="contentinfo">
      <div className="max-w-content mx-auto px-6 md:px-10">
        <Link href="/" className="inline-flex items-center gap-4 mb-12 py-2" aria-label={`${SITE_NAME} home`}>
          <span className="logo-3d logo-3d--dark flex-shrink-0">
            <span className="logo-3d-inner block">
              <Image src="/logo.svg" alt="" width={240} height={240} className="h-28 w-auto md:h-36 object-contain block" />
            </span>
          </span>
          <span className="logo-text logo-text--dark">
