      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
        <div className="max-w-md">
          ...
          {showAuthFooter && !authLoading ? (
            <div className="mt-6 border-t border-white/10 pt-6">
              <p className="text-sm font-semibold uppercase tracking-[0.16em] text-white/68">Client area</p>
              <ul className="mt-3">
          ...
          <div className="mt-6">
            <p className="text-sm font-semibold uppercase tracking-[0.16em] text-white/68">Stay connected</p>
        ...
        <div className="grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
          {footerGroups.map((group) => (
            <div key={group.title}>
              <p className="text-sm font-semibold uppercase tracking-[0.16em] text-white/68">{group.title}</p>
