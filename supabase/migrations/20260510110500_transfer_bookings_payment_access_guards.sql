-- Harden transfer booking payment/ownership guards.
-- 1) Non-privileged inserts must not seed admin/Stripe/refund fields.
-- 2) Email fallback reads are only for unattached website enquiries.
