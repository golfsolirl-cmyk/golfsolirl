-- One-time portal contact onboarding + client interest tickets (Transfers / Golf / Hotels)
...
comment on table public.portal_interest_tickets is
  'Client-initiated interest threads (category = transfers|golf_courses|hotels); messages in portal_interest_ticket_messages.';
...
-- Existing accounts with both name and phone already behave like “onboarding done”
