...
--   20260509112000_transfer_bookings_payment_insert_lock.sql
...
-- --- 20260505400000 --- (Stripe ids + trigger extension)
...
-- --- 20260505500000 --- (Refund tracking)
...
-- --- 20260509112000 --- (Protect payment fields on client inserts too)
